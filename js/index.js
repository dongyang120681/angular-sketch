	...
	$scope.back=function(ev){
    	...
    	clearCanvas();
    	previous.pop();
    	console.log(previous.pop());
    	if(previous.length>0){
      	ctx.putImageData(previous[previous.length-1],0,0);
		}
		else{
			alert('已经是干净的画布了^_^')
		}
	...
	canvas.onmousedown=function(e){
		...
		previous.push(ctx.getImageData(0,0,$scope.canvasWH.width,$scope.canvasWH.height))
		}
